...
def JobMatchFeedback(request, jobmatchid):
    ...
    if request.method == 'GET':
        ...
        feedback_message += "You share $" + str(len(shared_skills)) + "$ skill(s): " + shared_skill_pretty + "."
        ...
        feedback_message += "We have calculated your match score to be $" + str(int(percentage*100)) + "%$."
        feedback_message += "To improve your score try adding more skills or changing the language of your description"
